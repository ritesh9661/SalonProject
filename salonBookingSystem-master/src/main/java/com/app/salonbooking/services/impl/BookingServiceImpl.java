...
public class BookingServiceImpl implements BookingService {
    ...
    // public BookingServiceImpl(BookingRepository bookingRepository, ServiceItemService serviceItemService,
	// 		BarberService barberService, CustomerService customerService, ModelMapper mapper) {
	// 	super();
